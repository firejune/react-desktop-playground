...
class Row extends Component {
  ...
  render() {
    ...
    let osStyles = getOs() === 'win' ? styles.rowWin : styles.rowOsx
    let componentStyle = { ...style, ...styles.row, ...osStyles}
    ...
    if (isButtonsRow) {
      osStyles = getOs() === 'win' ? styles.buttonRowWin : styles.buttonRowOsx
      componentStyle = { ...componentStyle, ...osStyles }
    }
